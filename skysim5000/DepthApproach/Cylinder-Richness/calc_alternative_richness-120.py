...
output_file_path = file_path + 'Notebooks/skysim5000/Depth/calc-richness/Data-035-05/onetwenty/' # TODO: Gladys, please set it to your output directory
...
lambda_120 = Table.read(file_path + 'Data/halos/RichnessDepth_120_035_05.dat', format='ascii')
pixelss = list(np.unique(sky_02_1_all['pixel_id'][~np.isin(sky_02_1_all['pixel_id'],np.unique(lambda_120['pixelid']))]))
sky_02_1_all = sky_02_1_all[np.isin(sky_02_1_all['pixel_id'],pixelss)]
mask = (sky_02_1_all['pixel_id']==6080) | (sky_02_1_all['pixel_id']==6081)
