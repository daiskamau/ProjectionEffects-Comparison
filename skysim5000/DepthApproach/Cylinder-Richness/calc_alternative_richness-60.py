...
output_file_path = file_path + 'Notebooks/skysim5000/Depth/calc-richness/Data-035-05/sixty/' # TODO: Gladys, please set it to your output directory
...
lambda_60 = Table.read(file_path + 'Data/halos/RichnessDepth_60_035_05.dat', format='ascii')
