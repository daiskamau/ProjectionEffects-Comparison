...
output_file_path = file_path + 'Notebooks/skysim5000/Depth/calc-richness/Data-035-05/ninty/' # TODO: Gladys, please set it to your output directory
...
lambda_90 = Table.read(file_path + 'Data/halos/RichnessDepth_90_035_05.dat', format='ascii')
pixelss = list(np.unique(sky_02_1_all['pixel_id'][~np.isin(sky_02_1_all['pixel_id'],np.unique(lambda_90['pixelid']))]))
